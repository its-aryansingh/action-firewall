...
export default function HumanApprovalPage({ params }: ApprovePageProps) {
  ...
  if (loading) {
    return (
      <div className="max-w-xl mx-auto py-16 text-center text-slate-500 text-xs">
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4 space-y-6">
      ...
      <div className="text-center space-y-1">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 text-[#0C6CF2] border border-blue-200">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-200">
          <div>
            ...
            <div className="text-sm font-bold text-slate-900 mt-0.5">
              FreshBasket for Business <span className="text-slate-400 font-mono text-xs">({envelope?.merchant_id || "merchant_freshbasket"})</span>
            </div>
          </div>
            ...
            {(envelope?.slots ?? []).map((slot, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="flex h-5 w-5 rounded-full bg-blue-100 text-[#0C6CF2] text-[10px] font-bold items-center justify-center">
                    {i + 1}
                  </span>
        ...
        <div className="p-3.5 rounded-xl bg-blue-50/50 border border-blue-100 text-xs text-blue-900 space-y-1">
        ...
        <div>
          {isRedeemed ? (
            ...
            <button
              ...
              disabled={busy}
              className="w-full py-3 px-4 rounded-xl bg-[#0C6CF2] hover:bg-blue-600 disabled:opacity-50 text-white text-sm font-bold shadow-sm transition flex items-center justify-center gap-2"
            >
