    ...
    with store._conn() as cx:
        ...
        seeds = [
            (
                ...
                34800,
                0,
                "http://localhost:8000/simulated/payment-link/plink_seed01a",
                "act_seed_01",
                "act_seed_01",
                "ALLOW_ENVELOPE",
                now - 7200,
            ...
            (
                ...
                43800,
                1,
                "http://localhost:8000/simulated/payment-link/plink_seed02b",
                "act_seed_02",
                "act_seed_02",
                "ALLOW_ENVELOPE",
                now - 5400,
            ...
            (
                ...
                89900,
                0,
                "http://localhost:8000/simulated/payment-link/plink_seed03c",
                "act_seed_03",
                "act_seed_03",
                "ALLOW_ENVELOPE",
                now - 3600,
